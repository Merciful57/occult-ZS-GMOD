...
SWEP.ViewModel = "models/aether_gazer/v_osiris.mdl"
SWEP.WorldModel = "models/aether_gazer/w_osiris.mdl"
...
function SWEP:PlayHitSound()
	self:EmitSound("weapons/osiris/melee_axe_0"..math.random(1, 3)..".wav", 90, 135)
