...
ITEMSUBCAT_ZTRINKETS_DEFENSIVE = 1
ITEMSUBCAT_ZTRINKETS_OFFENSIVE = 2
ITEMSUBCAT_ZTRINKETS_PERFORMANCE = 3
...
GM.ItemCategories = {
	...
	[ITEMCAT_ZTRINKETS] = "Upgrade",
	[ITEMCAT_ZABILITY] = "Abilities"
}
...
GM:AddZPointShopItem("Place Spawn",			ITEMCAT_ZABILITY,		10,				"weapon_zs_fleshcreeper").SubCategory =								ITEMSUBCAT_ZTRINKETS_UTILITY
...
GM:AddPointShopItem("rpk74",		ITEMCAT_LEGENDARY,		360,			"weapon_zs_vdv")
