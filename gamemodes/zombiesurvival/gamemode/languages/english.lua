...
LANGUAGE.dont_have_enough_points					= "You don't have enough silver."
...
LANGUAGE.purchased_x_for_y_points					= "Purchased %s for %d silver!"
...
LANGUAGE.you_have_died								= "You have died. Use !human to respawn on the sigil of immortality."
LANGUAGE.you_were_killed_by_x						= "You were killed by %s . Use !human to respawn on the sigil of immortality."
...
LANGUAGE.points_for_surviving						= "You've gained %d silver for surviving."
...
LANGUAGE.zombie_invasion_in_x						= "Zombies will arive in %s"
LANGUAGE.intermission								= "Intermission"
LANGUAGE.press_f2_for_the_points_shop				= "Press F2 to buy weapons"
LANGUAGE.breath										= "Breath"
LANGUAGE.zombie_volunteers							= ""
...
LANGUAGE.number_of_initial_zombies_this_game		= ""
LANGUAGE.humans_closest_to_spawns_are_zombies		= "The humans closest to the zombie spawns will start as zombies."
LANGUAGE.waiting_for_players						= "Gather props and build a barricade..."
...
LANGUAGE.next_round_in_x							= "Next map in: %s"
